 ...
 * @author Davel-11
 */
public class next_level_1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {                                
            ...
            int veces_judadas = Integer.parseInt(request.getParameter("veces_judadas"));
            //out.println("veces_judadas: "+veces_judadas);
